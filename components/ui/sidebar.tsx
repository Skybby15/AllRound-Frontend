        ...
        >
            ...
            >
                <div
                    ...
                    //HERE YOU CAN CHANGE THE OPACITY OF THE SIDEBAR BG
                    className="flex size-full flex-col bg-sidebar/50 group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
                >
                    {children}
                </div>
            </div>
